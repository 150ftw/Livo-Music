...
export function FloatingPlayer() {
  ...
  return (
    ...
    >
      <div className="relative rounded-2xl bg-[#09090b]/95 backdrop-blur-2xl border border-white/[0.12] shadow-[0_25px_60px_rgba(0,0,0,0.95)] p-2.5 sm:p-3 overflow-visible transition-all">
            ...
            >
              ...
              {showVolumeSlider && (
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 pb-2">
                  <div className="bg-[#121216] border border-white/10 p-2 rounded-xl shadow-xl flex items-center h-24 w-7 justify-center">
                    <input
                      type="range"
                      min="0"
                      max="1"
                      ...
                      className="accent-white h-20 w-1.5 [writing-mode:vertical-lr] [direction:rtl] cursor-pointer"
                    />
                  </div>
                </div>
              )}
        ...
        <div className="flex items-center justify-between px-1 pt-2 mt-1 border-t border-white/[0.04] text-[10px] font-mono text-[#8e8c87]">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[#8e8c87]/90">Full Song Audio • Powered by Spotify</span>
          </div>
          ...
          <a
            ...
            className="hover:text-emerald-400 transition-colors flex items-center gap-1 text-[10px]"
